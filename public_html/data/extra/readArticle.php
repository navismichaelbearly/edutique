	...
	
{
	  ...
	  $stmt = $mysqli->prepare("UPDATE edu_user_task SET task_stages  = ? WHERE article_id = ? and school_id = ? and assigned_to = ? and mag_id = ?");	
	  $stmt->bind_param("sssss", $param_task_stages,$param_article_id,$param_school_id,$param_assigned_to, $param_mag_id);    
